...
const taskSyncMutationActionLabels: Record<string, string> = {
   ...
   'milestone.activate': 'فعال‌سازی گام',
   'milestone.archive': 'بایگانی گام',
   'milestone.cancel': 'لغو گام',
   'milestone.complete': 'تکمیل گام',
   'milestone.create': 'ایجاد گام',
   'milestone.reopen': 'بازگشایی گام',
   'milestone.reorder': 'تغییر ترتیب گام',
   'milestone.restore': 'بازگردانی گام',
   'milestone.update': 'به‌روزرسانی گام',
