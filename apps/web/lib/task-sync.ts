...
const taskSyncMutationActionLabels: Record<string, string> = {
   ...
   'milestone.activate': 'فعال‌سازی هدف',
   'milestone.archive': 'بایگانی هدف',
   'milestone.cancel': 'لغو هدف',
   'milestone.complete': 'تکمیل هدف',
   'milestone.create': 'ایجاد هدف',
   'milestone.reopen': 'بازگشایی هدف',
   'milestone.reorder': 'تغییر ترتیب هدف',
   'milestone.restore': 'بازگردانی هدف',
   'milestone.update': 'به‌روزرسانی هدف',
